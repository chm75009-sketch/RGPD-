...
- **Données séparées de l'interface.** La base vit dans `data/jurisprudence.js` (un tableau
  d'objets conforme à `data/schema.json`). L'interface (`index.html`) ne contient aucune
...
Voir `docs/methodologie-sources.md`.
